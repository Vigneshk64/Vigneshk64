...
|--------|-------------|-------|
| [MedCare](https://medcare-nine-theta.vercel.app) | Multi-role pharmacy management platform with AI drug interaction analysis | Next.js, Firebase, OpenRouter |
| [BillClear](https://alpha-techversehakathon.vercel.app) | AI-powered hospital billing transparency system | Next.js, Firebase, OpenRouter |
| [PortfolioAI](https://github.com/Vigneshk64) | Resume to portfolio generator using AI | React, Groq API |
